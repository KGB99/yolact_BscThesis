...
python3 eval.py --trained_model=weights/medical_ssd_resnet50_0_5000.pth  --config=medical_ssd_resnet50_config --output_coco_json --dataset=medical_test_subset_ssd --score_threshold=0.8
