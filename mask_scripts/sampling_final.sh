...
python3 sampling_experiments.py --coco_file=/cluster/project/infk/cvg/heinj/students/kbirgi/Annotations/trainSSD/amodal_labels_300.json --images_dir=/cluster/project/infk/cvg/heinj/datasets/bop/mvpsp --results_dir=final_visuals --trained_model=weights/pbr_random_and_kinect_5_30000.pth --create_labels=True --visualize_masks=True
deactivate
